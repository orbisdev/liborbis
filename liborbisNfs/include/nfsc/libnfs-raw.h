...
/*
 * Used for interfacing the api into an al eventsystem.
 *
 ...
 */
 int rpc_register_service(struct rpc_context *rpc, int program,
 ...
 *                    : data is NULL.
 */
 int rpc_connect_async(struct rpc_context *rpc, const char *server,
 ...
 *                    : data is NULL.
 */
 int rpc_connect_program_async(struct rpc_context *rpc,
                                     const char *server,
 ...
 *                    : data is NULL.
 */
 int rpc_connect_port_async(struct rpc_context *rpc, const char *server,
                                  int port,
                                  int program, int version,
                                  rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_pmap2_null_async(struct rpc_context *rpc,
                                rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_pmap2_getport_async(struct rpc_context *rpc, int program,
 ...
 *                      data is NULL.
 */
 int rpc_pmap2_set_async(struct rpc_context *rpc, int program,
 ...
 *                      data is NULL.
 */
 int rpc_pmap2_unset_async(struct rpc_context *rpc, int program,
                                 int version, int protocol, int port,
                                 rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_pmap2_callit_async(struct rpc_context *rpc, int program,
 ...
 *                      data is NULL.
 */
 int rpc_pmap3_null_async(struct rpc_context *rpc,
                                rpc_cb cb, void *private_data);
...
struct pmap3_mapping;
 int rpc_pmap3_set_async(struct rpc_context *rpc,
 ...
 *                      data is NULL.
 */
 int rpc_pmap3_unset_async(struct rpc_context *rpc,
                                 struct pmap3_mapping *map,
                                 rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_pmap3_getaddr_async(struct rpc_context *rpc,
                                   struct pmap3_mapping *map,
                                   rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_pmap3_dump_async(struct rpc_context *rpc,
                                rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_pmap3_callit_async(struct rpc_context *rpc, int program,
                                  int version, int procedure,
                                  char *data, int datalen,
                                  rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_pmap3_gettime_async(struct rpc_context *rpc,
                                   rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_mount3_null_async(struct rpc_context *rpc,
                                 rpc_cb cb, void *private_data);
 int rpc_mount_null_async(struct rpc_context *rpc,
                                rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_mount3_mnt_async(struct rpc_context *rpc, rpc_cb cb,
                                char *exportname, void *private_data);
 int rpc_mount_mnt_async(struct rpc_context *rpc, rpc_cb cb,
                               char *exportname, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_mount3_dump_async(struct rpc_context *rpc,
                                 rpc_cb cb, void *private_data);
 int rpc_mount_dump_async(struct rpc_context *rpc,
                                rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_mount3_umnt_async(struct rpc_context *rpc, rpc_cb cb,
                                 char *exportname,
                                 void *private_data);
 int rpc_mount_umnt_async(struct rpc_context *rpc, rpc_cb cb,
                                char *exportname,
                                void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_mount3_umntall_async(struct rpc_context *rpc,
                                    rpc_cb cb, void *private_data);
 int rpc_mount_umntall_async(struct rpc_context *rpc,
                                   rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_mount3_export_async(struct rpc_context *rpc,
                                   rpc_cb cb, void *private_data);
 int rpc_mount_export_async(struct rpc_context *rpc,
                                  rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_mount1_null_async(struct rpc_context *rpc,
                                 rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_mount1_mnt_async(struct rpc_context *rpc, rpc_cb cb,
                                char *exportname,
                                void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_mount1_dump_async(struct rpc_context *rpc,
                                 rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_mount1_umnt_async(struct rpc_context *rpc, rpc_cb cb,
                                 char *exportname,
                                 void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_mount1_umntall_async(struct rpc_context *rpc,
                                    rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_mount1_export_async(struct rpc_context *rpc,
                                   rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_nfs3_null_async(struct rpc_context *rpc,
                               rpc_cb cb, void *private_data);
 int rpc_nfs_null_async(struct rpc_context *rpc,
                              rpc_cb cb, void *private_data);
...
struct READ3args;
 int rpc_nfs3_read_async(struct rpc_context *rpc, rpc_cb cb,
                               ...
                               void *private_data);
 int rpc_nfs_read_async(struct rpc_context *rpc, rpc_cb cb,
                              struct nfs_fh3 *fh,
...
struct WRITE3args;
 int rpc_nfs3_write_async(struct rpc_context *rpc, rpc_cb cb,
                                ...
                                void *private_data);
 int rpc_nfs_write_async(struct rpc_context *rpc, rpc_cb cb,
                               struct nfs_fh3 *fh,
...
struct RMDIR3args;
 int rpc_nfs3_rmdir_async(struct rpc_context *rpc, rpc_cb cb,
                                ...
                                void *private_data);
 int rpc_nfs_rmdir_async(struct rpc_context *rpc, rpc_cb cb,
...
struct MKNOD3args;
 int rpc_nfs3_mknod_async(struct rpc_context *rpc, rpc_cb cb,
                                ...
                                void *private_data);
 int rpc_nfs_mknod_async(struct rpc_context *rpc, rpc_cb cb,
                               struct nfs_fh3 *fh,
 ...
 *                      data is NULL.
 */
 int rpc_nfs2_null_async(struct rpc_context *rpc,
                               rpc_cb cb, void *private_data);
...
struct READLINK2args;
 int rpc_nfs2_readlink_async(struct rpc_context *rpc, rpc_cb cb,
 ...
 *                      data is NULL.
 */
 int rpc_rquota1_null_async(struct rpc_context *rpc,
                                  rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_rquota2_null_async(struct rpc_context *rpc,
                                  rpc_cb cb, void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_nlm4_null_async(struct rpc_context *rpc, rpc_cb cb,
                               void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_nsm1_null_async(struct rpc_context *rpc, rpc_cb cb,
                               void *private_data);
 ...
 *                      data is NULL.
 */
 int rpc_nfs4_null_async(struct rpc_context *rpc, rpc_cb cb,
                               void *private_data);
